// Copyright (c) 2024-present The Aurum Core developers
 ...
 *
 * This header currently exposes an API for interacting with parts of Aurum
 ...
 * also not yet included in releases of Aurum Core.
 *
