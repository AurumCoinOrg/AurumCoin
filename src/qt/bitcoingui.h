...
/**
  Aurum GUI main class. This class represents the main window of the Aurum UI. It communicates with both the client and
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Aurum Transaction from file or clipboard */
