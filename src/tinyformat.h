...
#include <algorithm>
#include <attributes.h> // Added for Aurum Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Aurum Core
#include <util/string.h> // Added for Aurum Core
...
// Added for Aurum Core. Similar to std::runtime_format from C++26.
...
// Added for Aurum Core. Wrapper for checking format strings at compile time.
