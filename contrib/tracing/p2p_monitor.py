...
""" Interactive aurumd P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Aurum Core can enable. It uses BCC
...
def main(pid):
    peers = dict()
    print(f"Hooking into aurumd with pid {pid}")
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("USAGE:", sys.argv[0], "<pid of aurumd>")
        exit()
