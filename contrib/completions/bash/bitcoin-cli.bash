...
_bitcoin_cli() {
    ...
    # save and use original argument to invoke aurum-cli for -help, help and RPC
    # as aurum-cli might not be in $PATH
    bitcoin_cli="$1"
...
complete -F _bitcoin_cli aurum-cli
