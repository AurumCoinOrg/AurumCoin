# Bootstrappable Aurum Core Builds

This directory contains the files necessary to perform bootstrappable Aurum
Core builds.
...
To build Aurum Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Aurum Core version being built.
