...
Aurum Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Aurum Core

**When configuring Aurum Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Aurum Core:
...
variables will be set when generating the Aurum Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
