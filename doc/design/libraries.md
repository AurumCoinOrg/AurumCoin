...
| Name                     | Description |
|--------------------------|-------------|
| *libbitcoin_cli*         | RPC client functionality used by *aurum-cli* executable |
...
| *libbitcoin_node*        | P2P and RPC server functionality used by *aurumd* and *bitcoin-qt* executables. |
| *libbitcoin_util*        | Home for common functionality shared by different executables and libraries. Similar to *libbitcoin_common*, but lower-level (see [Dependencies](#dependencies)). |
| *libbitcoin_wallet*      | Wallet functionality used by *aurumd* and *aurum-wallet* executables. |
| *libbitcoin_wallet_tool* | Lower-level wallet functionality used by *aurum-wallet* executable. |
| *libbitcoin_zmq*         | [ZeroMQ](../zmq.md) functionality used by *aurumd* and *bitcoin-qt* executables. |
...
aurum-cli[aurum-cli]-->libbitcoin_cli;

aurumd[aurumd]-->libbitcoin_node;
aurumd[aurumd]-->libbitcoin_wallet;

bitcoin-qt[bitcoin-qt]-->libbitcoin_node;
bitcoin-qt[bitcoin-qt]-->libbitcoinqt;
bitcoin-qt[bitcoin-qt]-->libbitcoin_wallet;

aurum-wallet[aurum-wallet]-->libbitcoin_wallet;
aurum-wallet[aurum-wallet]-->libbitcoin_wallet_tool;
...
class bitcoin-qt,aurumd,aurum-cli,aurum-wallet bold
```
</td></tr><tr><td>
...
- *libbitcoin_common* is a home for miscellaneous shared code used by different Aurum Core applications. It should not depend on anything other than *libbitcoin_util*, *libbitcoin_consensus*, and *libbitcoin_crypto*.
