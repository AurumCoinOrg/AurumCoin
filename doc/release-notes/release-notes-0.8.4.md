Aurum-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/Aurum/bitcoin-0.8.4/
...
code, causing the Aurum-Qt or aurumd process to crash.
...
their own version of Aurum against Boost versions 1.50-1.52.
