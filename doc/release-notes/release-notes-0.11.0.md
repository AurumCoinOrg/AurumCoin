Aurum Core version 0.11.0 is now available from:
...
Block pruning allows Aurum Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that Aurum Core will 
...
- #5809 `46bfbe7` Add aurum-cli man page
...
- #5849 `41259ca` contrib/init/aurumd.openrc: Compatibility with previous OpenRC init script variables
...
- #6116 `30dc3c1` [OSX] rename Aurum-Qt.app to Aurum-Core.app
