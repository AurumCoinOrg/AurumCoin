Aurum version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Aurum/bitcoin-0.5.4/
...
http://gitorious.org/bitcoin/aurumd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Aurum-Qt notifications under Growl 1.3.
Increase required age of Aurum-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing Aurum-Qt over it. (Windows)
