...
The Aurum Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Aurum Core requires the ZeroMQ API >= 4.0.0
...
For instance:
    ...
    $ aurumd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubhashblock="tcp://[::1]:28333" \
               -zmqpubrawtx=unix:/tmp/aurumd.tx.raw \
...
From the perspective of aurumd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into aurumd directly. Furthermore, no information is
