...
Aurum Core has an internal benchmarking framework, with benchmarks
...
To monitor Aurum Core performance more in depth (like reindex or IBD): https://github.com/bitcoin-dev-tools/benchcoin
