...
* Update the following variables in [`src/kernel/chainparams.cpp`](/src/kernel/chainparams.cpp) for mainnet, testnet, and signet:
  ...
  - `m_assumeutxo_data` array should be appended to with the values returned by calling `aurum-cli -rpcclienttimeout=0 -named dumptxoutset utxo.dat rollback=<height or hash>`
...
Checkout the Aurum Core version you'd like to build:
...
- Announce the release:
  ...
  - Aurum Core announcements list https://bitcoincore.org/en/list/announcements/join/

  - Aurum Core Twitter https://twitter.com/bitcoincoreorg
