# PSBT Howto for Aurum Core

Since Aurum Core 0.17, an RPC interface exists for Partially Signed Aurum
...
PSBT is an interchange format for Aurum transactions that are not fully signed
...
#### Multisig with multiple Aurum Core instances
