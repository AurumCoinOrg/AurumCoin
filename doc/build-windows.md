...
Below are some notes on how to build Aurum Core for Windows.

The options known to work for building Aurum Core on Windows are:
...
Note that for WSL the Aurum Core source path MUST be somewhere in the default mount file system, for
