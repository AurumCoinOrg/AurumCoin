Contributing to Aurum Core
============================

The Aurum Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Aurum Core
...
Before you start contributing, familiarize yourself with the Aurum Core build
system and tests. Refer to the documentation in the repository on how to build
Aurum Core and how to run the unit tests, functional tests, and fuzz tests.
...
You may also participate in the [Aurum Core PR Review Club](https://bitcoincore.reviews/).
...
Most communication about Aurum Core development happens on IRC, in the
...
fork of Aurum Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the Aurum Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Aurum
Network Protocol consensus changes.

Whether a pull request is merged into Aurum Core rests with the project merge
maintainers.
...
Patches that change Aurum consensus rules are considerably more involved than
...
Where a patch set proposes to change the Aurum consensus, it must have been
