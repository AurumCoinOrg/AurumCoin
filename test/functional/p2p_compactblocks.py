#!/usr/bin/env python3
# Copyright (c) 2016-present The Aurum Core developers
...
# TestP2PConn: A peer we use to send messages to aurumd, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes aurumd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that aurumd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for aurumd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # aurumd will not send blocktxn responses for blocks whose height is
