...
# The block reward of coinbaseoutput.nValue (50) AUR/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 AUR/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"aurum-cli -h\" for help or \"aurum-cli listwallets\" to see "
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `aurum-cli getblockchaininfo`")
        ...
        # Prevent aurum-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and aurum-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and aurum-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (AUR/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (AUR/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 AUR) to the default wallet.
            ...
            # Test aurum-cli -generate with -rpcwallet in multiwallet mode.
